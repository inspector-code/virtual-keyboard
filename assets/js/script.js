...
const rowsOrder = [
    ...
    ['ShiftLeft', 'KeyZ', 'KeyX', 'KeyC', 'KeyV', 'KeyB', 'KeyN', 'KeyM', 'Comma', 'Period', 'Slash', 'Lang'],
    ['ControlLeft', 'AltLeft', 'Space', 'SoundButton', 'Speech', 'ArrowLeft', 'ArrowDown', 'ArrowUp', 'ArrowRight']
]
